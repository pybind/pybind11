...
//        .def(py::init<int, int>());
    ...
    py::class_<VanillaDictMix1, Vanilla, WithDict>(m, "VanillaDictMix1", py::dynamic_attr()).def(py::init<>());
    py::class_<VanillaDictMix2, WithDict, Vanilla>(m, "VanillaDictMix2", py::dynamic_attr()).def(py::init<>());
