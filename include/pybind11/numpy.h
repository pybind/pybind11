...
#if !defined(__GNUC__) || __GNUC__ >= 5 || (defined(__clang__) && __has_feature(is_trivially_copyable))
    std::is_trivially_copyable<T>,
#else
    // libstdc++ < 5 doesn't implement is_trivially_copyable, so approximate it
